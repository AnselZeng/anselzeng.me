...
export default function Page() {
  ...
  const territories = [
    "Aruba (ABC Islands, Leeward Antilles)",
    "Bonaire (ABC Islands, Leeward Antilles)",
    "Curaçao (ABC Islands, Leeward Antilles)",
        ...
        <Container px={12} maxW="container.lg">
          ...
          <Accordion allowToggle width="100%">
            <Stack spacing={{ base: 0, lg: 12 }} direction={{ base: "column", lg: "row" }}>
              <Box width="100%">
                <AccordionItemList title="🇺🇳 Countries (16/195)" items={countries} />
                <AccordionItemList title="🌐 Territories" items={territories} />
              </Box>
              <Box width="100%">
                <AccordionItemList title="🇨🇦 Canadian Provinces and Territories (8/13)" items={canadaItems} />
